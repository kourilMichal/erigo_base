...
class JsUtility
{
     ...
     * @return string
     */
    public static function convertObjectToJson(string $jsObjectString)
    {
        $replacedStringsList = [];
    ...
    // ERIGO
        // 7.5 Convert "true", "false" and "null" values to real system values
        $convertedString = preg_replace('/:\"(true|false|null)\"/', ':$1', $convertedString);
    // ERIGO
     ...
     * @return array|null
     */
    public static function convertObjectToArray(string $input): ?array
    {
        $json = self::convertObjectToJson($input);
